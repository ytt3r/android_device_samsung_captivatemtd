...
TARGET_RECOVERY_INITRC := device/samsung/captivate/recovery.rc

# Releasetools
TARGET_PROVIDES_RELEASETOOLS := true
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := ./device/samsung/captivate/releasetools/captivate_ota_from_target_files
TARGET_RELEASETOOL_IMG_FROM_TARGET_SCRIPT := ./device/samsung/captivate/releasetools/captivate_img_from_target_files
